...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      'Découvrez comment créer des factures professionnelles gratuitement en ligne. Guide complet pour freelances, auto-entrepreneurs et PME.',
...
La facturation en ligne gratuit n'a jamais été aussi simple. Avec Factumation, créez vos factures professionnelles en quelques secondes, sans inscription obligatoire et sans frais cachés.`,
  },
  {
    ...
    excerpt:
      'Apprenez à créer une facture professionnelle qui respecte toutes les normes légales. Tutoriel pas à pas avec notre générateur gratuit.',
...
- Envoyer vos documents directement par email`,
  },
  {
    ...
    excerpt:
      'La facturation électronique devient progressivement obligatoire en France. Découvrez le calendrier, les obligations et comment vous préparer.',
    keywords: [
...
La facturation électronique est une opportunité de moderniser vos processus. Commencez dès maintenant à digitaliser votre facturation pour être prêt le jour J.`,
  },
  {
    ...
    excerpt:
      'Learn how to create professional invoices for free online. Complete guide for freelancers, self-employed, and small businesses.',
...
Creating professional invoices has never been easier or more affordable. With Factumation, generate beautiful invoices in seconds, for free, with no hidden costs.`,
  },
  {
    ...
    excerpt:
      'Guide complet pour les auto-entrepreneurs qui veulent simplifier leur facturation. Mentions obligatoires, outils gratuits et bonnes pratiques.',
    keywords: [
...
export function getBlogPostsByLang(lang: 'fr' | 'en'): BlogPost[] {
